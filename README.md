            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm border-light">
                        <img src="image1 (1).png" class="card-img-top" alt="Shot 1">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm border-light">
                        <img src="image2.png" class="card-img-top" alt="Shot 2">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm border-light">
                        <img src="image3.png" class="card-img-top" alt="Shot 3">
                        <div class="card-body">
...
## OUTPUT:
![alt text](<Screenshot 2024-12-27 194648.png>)
